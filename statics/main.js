...
function initPortfolio() {
    ...
    (async function loadGitHubProjects() {
        ...
        // SECURITY: innerHTML below is only ever fed these static icon strings.
        // External data (repo names, descriptions, topics) must always be
        // inserted via textContent / createTextNode — never interpolated here.
        ...
        // Cache the repo list briefly so refresh-happy visitors don't burn the
        // unauthenticated GitHub rate limit (60 requests/hour/IP).
        ...
        try {
            ...
            console.debug('GitHub project crawl skipped:', e);
        }
    })();
